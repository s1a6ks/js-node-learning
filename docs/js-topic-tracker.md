...
| 11 | Основи | Перетворення типів | High | Next | Session 2 |
| 12 | Основи | Базові оператори, математика | Medium | Later | Пройдемо швидко |
| 13 | Основи | Оператори порівняння | High | Next | Session 2, особливо `==` vs `===` |
| 14 | Основи | Умовні розгалуження: `if`, `?` | Medium | Later | Освіжимо коротко |
| 15 | Основи | Логічні оператори | High | Later | Важливо через truthy/falsy |
| 16 | Основи | Nullish coalescing `??` | High | Later | Важливо для backend default values |
| 17 | Основи | Цикли: `while`, `for` | Medium | Later | Пройдемо швидко |
| 18 | Основи | `switch` | Low | Later | Достатньо базового розуміння |
| 19 | Основи | Функції | High | Later | Окрема сесія |
| 20 | Основи | Функціональні вирази | High | Later | Важливо для JS стилю |
| 21 | Основи | Стрілкові функції | High | Later | Важливо для callbacks і async |
...
| # | Розділ | Тема | Пріоритет | Статус | Нотатка |
|---|---|---|---|---|---|
| 29 | Об'єкти | Об'єкти | High | Later | Один з ключових блоків |
| 30 | Об'єкти | Копіювання об'єктів та посилання | High | Later | Дуже важливо після `C#` і для backend |
| 31 | Об'єкти | Збирання сміття | Low | Later | Оглядово |
| 32 | Об'єкти | Методи об'єкта, `this` | High | Later | Окрема складна тема |
| 33 | Об'єкти | Конструктори, `new` | Medium | Later | Потрібно розуміти, але без занурення |
| 34 | Об'єкти | Optional chaining `?.` | High | Later | Часто використовується |
...
| 40 | Типи даних | Масиви | High | Later | Ключова тема |
| 41 | Типи даних | Методи масивів | High | Later | `map`, `filter`, `find`, `reduce` |
